...
[source,javascript]
----
- "urlExpression": "grel:\"http://api.geonames.org/`"gtopo30"`?lat=\"+cells['uniqueDecimalCoordinates'].value.split(\" | \")[0]+\"&lng=\"+cells['uniqueDecimalCoordinates'].value.split(\" | \")[1]+\"&username=demo\"",
----
