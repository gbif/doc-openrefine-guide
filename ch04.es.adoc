...
A partir del campo [source]`"scientificName"`, cree una nueva columna a partir de una dirección URL haciendo click en la &#9660; azul del campo y siguiendo la siguiente ruta (<<img-fig-43,Figura 43>>):
...
Haga click en "la &#9660; azul del campo [source]`"GeoLocate_Json_georref"` > Editar columnas > Agregar columna basada en esta columna".
