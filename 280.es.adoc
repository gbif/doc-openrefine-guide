...
Para marcar todos esos registros con una bandera, haga click en menu:la{sp}&#9660;{sp}azul{sp}del{sp}campo{sp}“Todo”[] y siga la siguiente ruta (<<img-fig-36,Figura 36>>):
