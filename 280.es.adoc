...
Para marcar todos esos registros con una bandera, haga click en menu:la{sp}&#9660;{sp}azul{sp}del{sp}campo{sp}“Todo”[] y siga la siguiente ruta (<<img-fig-38,Figura 38>>):
...
Se abrirá una ventana como la mostrada en la <<img-fig-39,Figura 39>>. Asigne un nombre al campo. Por ejemplo, si sus banderas significan que ha detectado errores en los registros, puede llamarlo “tieneError”.
...
. Cree una faceta para la bandera. Haga click en "la &#9660; azul sobre el campo “Todo” > Facetas > Faceta por bandera" (<<img-fig-40,Figura 40a>>).
...
. Haga click nuevamente sobre "la &#9660; azul del campo “Todo” > Editar filas > Eliminar todas las filas que encajen" (<<img-fig-40,Figura 40b>>).
