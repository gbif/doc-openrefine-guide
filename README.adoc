...
It is available in Spanish in both HTML and PDF at https://labs.gbif.org/documents/openrefine-guide/[Guía de Uso Básico de OpenRefine para la limpieza de datos sobre biodiversidad]. The location of these documents is currently considered temporary.
