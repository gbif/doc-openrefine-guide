...
Para marcar todos esos registros con una bandera, haga click en la &9660; azul del campo [source]`"Todo"` y siga la siguiente ruta (<<img-fig-36,Figura 36>>):
...
Para desmarcar todos esos registros, puede hacer click en la &#9660; azul del campo [source]`"Todo"` y seguir la ruta:
...
. Cree una faceta para la bandera. Haga click en "la &#9660; azul sobre el campo [source]`"Todo"` > Facetas > Faceta por bandera" (<<img-fig-38,Figura 38a>>).
...
. Haga click nuevamente sobre "la &#9660; azul del campo [source]`"Todo"` > Editar filas > Eliminar todas las filas que encajen" (<<img-fig-38,Figura 38b>>).
