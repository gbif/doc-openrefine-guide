...
El conjunto de datos modelo utilizado en esta guía (EjercicioModelo_OpenRefine_Datos.csv) puede obtenerse a través de: https://tinyurl.com/yd8mekzw. Descargar el archivo en formato .CSV, y no manipularlo en otros programas (e.g., MS Excel) antes de abrirlo en OpenRefine, dado que ello puede cambiar los formatos y/o codificación del archivo.
