...
El conjunto de datos modelo utilizado en esta guía puede obtenerse aquí: <</data/EjercicioModelo_OpenRefine_Datos#,EjercicioModelo_OpenRefine_Datos.csv>>. Descargar el archivo, y no manipularlo en otros programas (e.g., MS Excel) antes de abrirlo en OpenRefine, dado que ello puede cambiar los formatos y/o codificación del archivo.
