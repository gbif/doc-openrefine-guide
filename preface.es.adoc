...
La versión de OpenRefine utilizada para la confección de esta guía es OpenRefine 3.3. Aunque la última versión disponible es la 3.4.1 esta ha presentado algunos problemas de memoria por lo tanto no se aborda en esta guía.
